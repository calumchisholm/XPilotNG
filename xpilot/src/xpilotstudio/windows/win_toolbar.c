...
"Pick Item\0Add Vertex\0Delete Vertex\0Move Item\0Delete Item\0"
...
TBBUTTON tbmapmodify[] = 
{
	...
	3, IDM_MOVEITEM, TBSTATE_ENABLED, TBSTYLE_CHECKGROUP, 0, 0, 0, 0,
	4, IDM_DELETEITEM, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 0,
} ;
...
IDM_PICKITEM, IDM_ADDVERTEX, IDM_DELVERTEX, IDM_MOVEITEM, IDM_DELETEITEM,
...
#define NUMTOOLBARS 9
	struct toolbar toolbars[NUMTOOLBARS] =
	{
		...
		{&tbmapmodify[0], &hwndMapModifyToolBar, dwToolBarStyles | CCS_NORESIZE, 5, hInst, IDB_MAPMODIFYTOOLBAR, 0, 54, 24, 135, &iSelectionMapModify, IDM_PICKITEM},
		{&tbwormhole[0], &hwndWormholeToolBar, dwToolBarStyles | CCS_NOMOVEY | CCS_NORESIZE, 3, hInst, IDB_WORMHOLESUBBAR, 0, 190, TOOLSWIDTH, 40, &iSelectionWormhole, IDM_MAP_WORM_NORMAL},
		{&tbpolarity[0], &hwndPolarityToolBar, dwToolBarStyles | CCS_NOMOVEY | CCS_NORESIZE, 2, hInst, IDB_POLARITYSUBBAR, 0, 190, TOOLSWIDTH, 40, &iSelectionPolarity, IDM_MAP_POSITIVE},
		{&tbwalltype[0], &hwndWallTypeToolBar, dwToolBarStyles | CCS_NOMOVEY | CCS_NORESIZE, 2, hInst, IDB_WALLTYPESUBBAR, 0, 190, TOOLSWIDTH, 40, &iSelectionWallType, IDM_MAP_NORMAL},
