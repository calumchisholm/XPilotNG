...
char szTbStrings[] ="New\0Open\0Save\0Cut\0Copy\0Paste\0Undo\0Pen\0Erase\0"
"Clear\0"
"Crop\0Zoom In\0Zoom Out\0Rotate\0"
...
"Pick Item\0Full Solid\0Cannon\0Base\0"
...
"Positive\0Negative\0Check Map\0View Source\0Launch Map\0Next Check Point\0"
...
TBBUTTON tbmaptools[] = 
{
	1, IDM_ZOOMIN, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 0,
	2, IDM_ZOOMOUT, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 0,
//	0, IDM_CLEAR, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 0,
//	11, IDM_CROP, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 0,
//	0, 0, TBSTATE_ENABLED, TBSTYLE_SEP,0,0,0,0,
...
//	7, IDM_CYCLEH, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 0,
//	9, IDM_CYCLEHNEG, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 0,
//	8, IDM_CYCLEV, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 0,
//	10, IDM_CYCLEVNEG, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 0,
//	0, 0, TBSTATE_ENABLED, TBSTYLE_SEP,0,0,0,0,
	6, IDM_PROPERTIES, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 0,
//	12, IDM_MAPSOURCE, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 0,
//	13, IDM_LAUNCHMAP, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0, 0, 0,
} ;
...
TBBUTTON tbmapsyms[] = 
{
	15, IDM_MAPPICK, TBSTATE_ENABLED, TBSTYLE_CHECKGROUP, 0, 0, 0, 0,
...
//	12, IDM_MAP_CURRENT, TBSTATE_INDETERMINATE, TBSTYLE_CHECKGROUP, 0, 0, 0, 0,
	13, IDM_MAP_DECOR, TBSTATE_ENABLED, TBSTYLE_CHECKGROUP, 0, 0, 0, 0,
...
IDM_EDIT_UNDO,IDM_PEN,IDM_ERASE,
IDM_CLEAR,IDM_CROP,IDM_ZOOMIN,IDM_ZOOMOUT, IDM_ROTATE,
IDM_MIRRORV,IDM_MIRRORH,IDM_CYCLEH,IDM_CYCLEHNEG,IDM_CYCLEV,
IDM_CYCLEVNEG,IDM_PROPERTIES,IDM_MAPPICK, IDM_MAP_WALL,IDM_MAP_CANNON,
...
IDM_MAP_CURRENT,IDM_MAP_DECOR,IDM_MAP_POSITIVE,IDM_MAP_NEGATIVE,
...
#define NUMTOOLBARS 7
	struct toolbar toolbars[NUMTOOLBARS] =
	{
		...
		{&tbmaptools[0], &hwndMapToolsToolBar, dwToolBarStyles | CCS_NOMOVEY | TBSTYLE_FLAT, 3, hInst, IDB_MAPTOOLSTOOLBAR, 0, 25, 0, 0, NULL, 0},
		{&tbmapsyms[0], &hwndMapSymsToolBar, dwToolBarStyles | CCS_NORESIZE, 9, hInst, IDB_BLOCKSTOOLBAR, 0, 54, TOOLSWIDTH, 135, &iSelectionMapSyms, IDM_MAPPICK},
