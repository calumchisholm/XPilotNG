...
int Send_score_object(connection_t *connp, double score, clpos pos, const char *string);
...
int Send_wreckage(connection_t *connp, clpos pos, int wrtype, int size, int rot);
int Send_asteroid(connection_t *connp, clpos pos, int type, int size, int rot);
...
int Send_ship(connection_t *connp, clpos pos, int id, int dir, int shield, int cloak, int eshield, int phased, int deflector);
int Send_refuel(connection_t *connp, clpos pos1, clpos pos2);
int Send_connector(connection_t *connp, clpos pos1, clpos pos2, int tractor);
